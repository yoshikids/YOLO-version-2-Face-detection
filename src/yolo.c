...
void train_yolo(char *cfgfile, char *weightfile)
{
    ...
    char *backup_directory = "/home/darknet-face/backup/";
    srand(time(0));
...
void image_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    image **alphabet = load_alphabet();
    network net = parse_network_cfg(cfgfile);
    if(weightfile){
...
void run_yolo(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "image")) image_yolo(cfg, weights, filename, thresh);
    else if(0==strcmp(argv[2], "train")) train_yolo(cfg, weights);
    else if(0==strcmp(argv[2], "valid")) validate_yolo(cfg, weights);
    else if(0==strcmp(argv[2], "recall")) validate_yolo_recall(cfg, weights);
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, voc_names, 1, frame_skip, prefix, .5);
}
